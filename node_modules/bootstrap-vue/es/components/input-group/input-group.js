...
var _default = _vue.default.extend({
  ...
  render: function render(h, _ref) {
    ...
    if (props.prepend || props.prependHTML || (0, _normalizeSlot.hasNormalizedSlot)('prepend', $scopedSlots, $slots)) {
      childNodes.push(h(_inputGroupPrepend.default, [// Prop
      props.prepend || props.prependHTML ? h(_inputGroupText.default, {
    ...
    if (props.append || props.appendHTML || (0, _normalizeSlot.hasNormalizedSlot)('append', $scopedSlots, $slots)) {
      childNodes.push(h(_inputGroupAppend.default, [// prop
      props.append || props.appendHTML ? h(_inputGroupText.default, {
