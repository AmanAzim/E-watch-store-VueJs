...
import { directivesPlugin } from './index.esm'; // Export all directive group plugins and directives as named exports

export * from './index.esm'; // Export all legacy named directive group plugins as named exports
// To be removed in stable release

export * from './plugins-legacy'; // Default export is a plugin that installs all plugins
